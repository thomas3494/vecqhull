...
functions that can be used to measure what bandwidths can be achieved in
practice. We obtained the best results by pinning threads to cores and disabling
hyperthreading.
...
can only happen due to roundoff error. We have made the arbitrary decision
to put these in $S_1$.
...
and $8|CH(S_2)|$ bytes to place $CH(S_1)$ and $CH(S_2)$ next to eachother in
...
Table~\ref{table:bw} that we are able to get close ($83\%$) of this 
