...
instruction that is present in the AVX-512 instruction set \cite{Bramas17},
...
order. In these common cases permuting 
$[c_1^{min}, c_1^{\max}) \cup [c_2^{min}, c_2^{\max})$ is not performance
critical and can be done with a stock Dutch National Flag Algorithm.
