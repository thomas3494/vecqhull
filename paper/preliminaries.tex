...
\begin{algorithmic}[1]
    ...
    \Function{Hull}{P, p, r, q}
        ...
        \Else{}
            ...
            \State $H := \{p\}$ \Call{Hull}{$S_1$, $p$, $r_1$, $r$}
                   $\cup \{r\} \cup$ \Call{Hull}{$S_2$, $r$, $r_2$, $q$} 
                   $\cup \{q\}$.
        \EndIf
    \EndFunction
\end{algorithmic}
\captionof{algorithm}{Quickhull algorithm. By abuse of notation we assume
                      the unions in $H$ are ordered.}
...
\begin{minipage}[t]{.5\textwidth}
    ...
    \captionof{figure}{The points $p$ and $q$ are the left-most and 
